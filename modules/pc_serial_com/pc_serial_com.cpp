...
static void commandShowGatePassword();
...
static void commandShowGatePassword(){
    pcSerialComStringWrite("The Gate Password is:\r\n");
    pcSerialComStringWrite(gateCodeSequence);
...
static void pcSerialComCommandUpdate( char receivedChar )
{
    switch (receivedChar) {
        ...
        case 'g': case 'G': commandShowGatePassword(); break;
...
static void availableCommands()
{
    ...
    pcSerialComStringWrite( "Press 'g' or 'G' to get the gate password\r\n" );
    pcSerialComStringWrite( "\r\n" );
}
